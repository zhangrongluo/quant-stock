...
if __name__ == "__main__":
    ...
    while True:
        ...
        if strategy in STRATEGIES:
            ...
            print(f"{'extra_rate_min':<20}: {min(evaluate_result['delta_rate']):.2%}")
            print(f"{'extra_rate_max':<20}: {max(evaluate_result['delta_rate']):.2%}")
            print(f"{'extra_rate_last':<20}: {evaluate_result['delta_rate'][-1]:.2%}")
            print('++'*50)